...
public function Header() {
    ...
    // Title
    $this->Cell(0, 15, 'Informe de Generos Music X', 0, false, 'C', 0, '', 0, false, 'M', 'M');
}
	...
	public function ColoredTable($header,$data) {
		...
		$fill = 0;
		foreach ($data as $row ){
			$this->Cell($w[0], 6, $row['idgenero'], 'LR', 0, 'C', $fill);
...
// column titles
$header = array('Id Genero', 'Nombre del Genero');
...
$pdf->Output('ReporteGeneros.pdf', 'I');
