...
<style> 
        ...
        <div class="col s12  ">
            <div class="card">
                ...
                <div class="card-content">
                    <span><h3>Tabla de Generos musicales</h3></span>
                    <table id="cur" class="highlight bordered dataTable">
                        <thead>
                           <tr><th>Nombre del genero musica</th><th></th></tr>
                        </thead>
                        <tbody>
                            <?php
                                include_once("../congenero/Cargageneros.php");
                            ?>
                        </tbody>
                    </table>
                </div>
   ...
   <div class="modal" id="modalRegistro">
       <div class="modal-content">
           <h4>Alta y Edición de Generos</h4>
           <br>
           <form id="frm-genero" method="post" enctype="multipart/form-data" >
              <div class="row">
                   <div class="input-field col s12">
                       <input type="hidden" id="pk" name="pk" value="0">
                       <input type="text" id="genero" name="genero" class="validate">
   ...
   <?php include_once("../Fo/footer.php"); ?>
    ...
    <script type="text/javascript" src="../resources/js/genero.js"></script>
